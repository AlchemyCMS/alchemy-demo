...
"5.0-stable".tap do |branch|
  ...
  gem "alchemy_i18n", github: "AlchemyCMS/alchemy_i18n", branch: "2.3-stable"
  gem "alchemy_cloudinary", github: "AlchemyCMS/alchemy_cloudinary", branch: "main"
